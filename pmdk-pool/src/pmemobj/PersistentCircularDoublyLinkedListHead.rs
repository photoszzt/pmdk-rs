...
impl<T: ListEntryPersistable> Initializable for PersistentCircularDoublyLinkedListHead<T> {
    ...
    unsafe fn initialize(
        pointer_to_uninitialized_memory_to_use_for_fields: *mut Self,
        object_pool: *mut PMEMobjpool,
    ) {
        debug_assert!(
            pointer_to_uninitialized_memory_to_use_for_fields.is_not_null(),
            "pointer_to_uninitialized_memory_to_use_for_fields is null"
        );
        ...
        (&mut instance.lock as *mut PMEMmutex).zero(object_pool);
    }
}
...
impl<T: ListEntryPersistable> PersistentCircularDoublyLinkedListHead<T> {
    ...
    pub fn insert_at_head(
        ...
        element: PersistentObject<T>,
    ) -> Result<(), PmdkError> {
        self.insert(
            object_pool,
            element,
            PersistentObject::null(),
            POBJ_LIST_DEST_HEAD as i32,
        )
    }
    ...
    fn insert(
        ...
        let result = unsafe {
            pmemobj_list_insert(
                object_pool.0,
                T::PERSISTENT_CIRCULAR_DOUBLY_LINKED_LIST_ENTRY_FIELD_OFFSET,
    ...
    #[inline(always)]
    pub fn allocate_and_insert_at_head(
        &mut self,
        object_pool: &ObjectPool,
        arguments: &mut T::Arguments,
    ) -> Result<PersistentObject<T>, PmdkError> {
        self.allocate_and_insert(
            object_pool,
            arguments,
            PersistentObject::null(),
            POBJ_LIST_DEST_HEAD as i32,
    ...
    #[inline(always)]
    pub fn allocate_and_insert_before_index(
        &mut self,
        object_pool: &ObjectPool,
        arguments: &mut T::Arguments,
        index: PersistentObject<T>,
    ...
    #[inline(always)]
    pub fn allocate_and_insert_after_index(
        &mut self,
        object_pool: &ObjectPool,
        arguments: &mut T::Arguments,
        index: PersistentObject<T>,
    ...
    #[inline(always)]
    pub fn allocate_and_insert_at_tail(
        &mut self,
        object_pool: &ObjectPool,
        arguments: &mut T::Arguments,
    ) -> Result<PersistentObject<T>, PmdkError> {
    ...
    #[inline(always)]
    pub fn remove_from_this_list_and_insert_new_list_at_head(
        &mut self,
        object_pool: &ObjectPool,
        to: &mut Self,
        element: PersistentObject<T>,
    ) -> Result<(), PmdkError> {
        self.remove_from_this_list_and_insert_new_list(
            object_pool,
            to,
            element,
            PersistentObject::null(),
    ...
    #[inline(always)]
    pub fn remove_from_this_list_and_insert_new_list_before_index(
        &mut self,
        object_pool: &ObjectPool,
        to: &mut Self,
        element: PersistentObject<T>,
    ...
    #[inline(always)]
    pub fn remove_from_this_list_and_insert_new_list_after_index(
        &mut self,
        object_pool: &ObjectPool,
        to: &mut Self,
        element: PersistentObject<T>,
    ...
    #[inline(always)]
    pub fn remove_from_this_list_and_insert_new_list_at_tail(
        &mut self,
        object_pool: &ObjectPool,
        to: &mut Self,
        element: PersistentObject<T>,
    ...
    #[inline(always)]
    fn remove_from_this_list_and_insert_new_list(
        &mut self,
        object_pool: &ObjectPool,
        to: &mut Self,
        element: PersistentObject<T>,
        index: PersistentObject<T>,
        direction_toward: c_int,
    ) -> Result<(), PmdkError> {
        debug_assert!(element.is_not_null(), "element is null");
...
impl<T: ListEntryPersistable> PersistentCircularDoublyLinkedListHead<T> {
    ...
    pub fn tail(&self) -> Option<&PersistentObject<T>> {
        ...
        if unlikely(self.is_empty()) {
            ...
            unsafe { &*pointer_to_list_entry_field_holder }
                .list_entry_field()
                .previous()
        }
    }
